...
public final class SysModuleBuiltins extends PythonBuiltins {
    ...
    public void postInitialize0(Python3Core core) {
        ...
        // `pycache_prefix` and `_stdlib_dir` are runtime-dependent (option / context home, and the
        // BYTECODE_DSL pycache env var) — set in patchRuntimeSysState, not baked into preinit.
